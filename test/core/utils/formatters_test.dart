  ...
  group('Formatters Tests', () {
    ...
    group('Date Formatting', () {
      ...
      test('should format date grouping', () {
        ...
        expect(
          DateFormatter.formatDateGrouping(today, now: referenceNow),
          equals('Today'),
        );
        expect(
          DateFormatter.formatDateGrouping(yesterday, now: referenceNow),
          equals('Yesterday'),
        );
        expect(
          DateFormatter.formatDateGrouping(thisYear, now: referenceNow),
          equals('Aug 15'),
        );
        expect(
          DateFormatter.formatDateGrouping(lastYear, now: referenceNow),
          equals('Aug 15, 2024'),
        );
      });
