  ...
  group('Validators', () {
    group('validateRequired', () {
      ...
      test('should use custom field name in error message', () {
        ...
        expect(
          Validators.validateRequired('', 'Email'),
          equals('Email is required'),
        );
        expect(
          Validators.validateRequired('   ', 'Password'),
    ...
    group('validateAmount', () {
      ...
      test('should handle edge cases', () {
        expect(
          Validators.validateAmount('0.00'),
          equals('Amount must be greater than 0'),
        );
        expect(
          Validators.validateAmount('100.123'),
          isNull,
        ); // Accepts decimal places
        expect(
          Validators.validateAmount('1e2'),
          isNull,
    ...
    group('validateMinLength', () {
      ...
      test('should return error for short values', () {
        expect(
          Validators.validateMinLength('123', 5),
      ...
      test('should use custom field name in error message', () {
        expect(
          Validators.validateMinLength('123', 5, 'Password'),
          equals('Password must be at least 5 characters'),
        );
        expect(
          Validators.validateMinLength('', 1, 'Username'),
          equals('Username is required'),
        );
        expect(
          Validators.validateMinLength(null, 3, 'Description'),
      ...
      test('should handle various minimum lengths', () {
        ...
        expect(
          Validators.validateMinLength('a', 2),
    ...
    group('Edge Cases', () {
      test('should handle whitespace properly', () {
        expect(Validators.validateRequired('   '), equals('Field is required'));
        expect(
          Validators.validateMinLength('   ', 5),
          equals('Field must be at least 5 characters'),
        );
        expect(
          Validators.validateMinLength('', 5),
      ...
      test('should handle special characters in amounts', () {
        expect(
          Validators.validateAmount(r'$100'),
          equals('Enter a valid amount'),
        );
        expect(
          Validators.validateAmount(r'100.00$'),
          equals('Enter a valid amount'),
        );
        expect(
          Validators.validateAmount('1,000'),
          equals('Enter a valid amount'),
        );
      });
